...
func GetDefaultLogger(userId string, url string, method string) *zap.SugaredLogger {
	...
	return logger.With([]zap.Field{{Key: "UserId", Type: zapcore.StringType, String: userId}, {Key: "url", Type: zapcore.StringType, String: url}, {Key: "method", Type: zapcore.StringType, String: method}}...).Sugar()
}
